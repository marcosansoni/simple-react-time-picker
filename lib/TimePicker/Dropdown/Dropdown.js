...
var Box = _styledComponents.default.div(_templateObject(), Color.white, Color.grayLight, function (props) {
  return props.width && props.width;
});

var ItemDisplayed = _styledComponents.default.div(_templateObject2(), function (props) {
  return props.centered && 'center';
});

var Icon = _styledComponents.default.div(_templateObject3());

var DropMenu = _styledComponents.default.div(_templateObject4(), Color.white, Color.grayLight);

var Cell = _styledComponents.default.div(_templateObject5(), function (props) {
  return props.isSelected ? Color.whiteDark : Color.white;
}, function (props) {
  return !props.isLast && "1px solid".concat(Color.grayLight);
});

var ContainerPerfectScrollBar = _styledComponents.default.div(_templateObject6(), function (props) {
...
var Dropdown = function Dropdown(_ref) {
  ...
  }, String(items[indexSelectedItem]).padStart(2, '0')), _react.default.createElement(Icon, {
    onFocus: function onFocus() {
